...
public class DataServiceImpl extends UnicastRemoteObject implements HeadQuarters {
	...
	private ExchangeRateDAOService hqDao;
	...
	public DataServiceImpl() throws RemoteException {
		hqDao = new ExchangeRateDAOService(JDBC_URL, USERNAME, PASSWORD);
