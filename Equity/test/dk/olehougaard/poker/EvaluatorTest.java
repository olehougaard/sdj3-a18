...
class EvaluatorTest {
	...
	void quadIsTheMostSignificantPair() {
		long hand = Hand.createHand("Ac", "Js", "Jd", "Jh", "Jc", "3c", "5c");
		assertEquals(11L, (Evaluator.evaluate(hand) & MOST_SIGNIFICANT_PAIR_MASK) >> MOST_SIGNIFICANT_PAIR_INDEX);
	}
	...
	void boatHasThreeOfAKindAsTheMSP() {
		long boat = Hand.createHand("Qs", "Jd", "Jh", "Jc", "Ac", "3c", "Ad");
		assertEquals(11L, (Evaluator.evaluate(boat) & MOST_SIGNIFICANT_PAIR_MASK) >> MOST_SIGNIFICANT_PAIR_INDEX);
	}
	
	@Test 
	void boatHasThreeOfAKindAsTheLSP() {
		long boat = Hand.createHand("Qs", "Jd", "Jh", "Jc", "Ac", "3c", "Ad");
		assertEquals(14L, (Evaluator.evaluate(boat) & LEAST_SIGNIFICANT_PAIR_MASK) >> LEAST_SIGNIFICANT_PAIR_INDEX);
	}
	...
	void aBoatIsNotAQuad() {
		long boat = Hand.createHand("Qs", "Jd", "Jh", "Jc", "Ac", "3c", "Ad");
		assertEquals(0L, Evaluator.evaluate(boat) & QUAD_MASK);
	}
	...
	void twoTripsIsABoat() {
		long boat = Hand.createHand("As", "Jd", "Jh", "Tc", "Ac", "3c", "Ad");
		long twoTrips = Hand.createHand("As", "Jd", "Jh", "Jc", "Ac", "3c", "Ad");
